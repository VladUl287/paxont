...
export function builder() {
    ...
    const applyModifier = <M extends BaseMeta<any, M>>(value: M, modify: Modifier<M>): M => {
    ...
    const nullable = <M extends BaseMeta<any, M>>(
        value: M,
    ...
    const map = <M extends BaseMeta<any, M>>(
        value: M,
    ...
    const set = <M extends BaseMeta<any, M>>(
        value: M,
    ...
    const object = <M extends Modifier<ObjectMeta<any>>[]>(...mods: M): ObjectMeta<AsObj<M, {}>> => {
        return {} as any
    }
    ...
    const array = <M extends BaseMeta<any, M>>(
        value: M, ...modifiers: Modifier<ArrayMeta<MetaValue<M>[], M>>[]
...
export const _object = <Mods extends Modifier<ObjectMeta<any>>[]>(...mods: Mods): ObjectMeta<AsObj<Mods, {}>> => {
    return {} as any
}
