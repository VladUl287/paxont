...
const defaultBuilderOptions: BuilderOptions = {
    ...
    globalPools: {
        number: arrayPool<number[]>({ ctor: Array }),
        string: arrayPool<string[]>({ ctor: Array }),
        bigint: arrayPool<bigint[]>({ ctor: Array }),
        boolean: arrayPool<boolean[]>({ ctor: Array }),
        nullable: arrayPool<null[]>({ ctor: Array }),
        object: arrayPool<object[]>({ ctor: Array, clear: fillWith({}) }),
        date: arrayPool<Date[]>({ ctor: Array, clear: fillWith(Date.prototype) }),
        set: arrayPool<Set<any>[]>({ ctor: Array, clear: fillWith(new Set()) }),
        map: arrayPool<Map<string, any>[]>({ ctor: Array, clear: fillWith(new Map()) }),
        array: arrayPool<Array<any[]>>({ ctor: Array, clear: fillWith(new Array()) }),
        i8: arrayPool<Int8Array>({ ctor: Int8Array }),
        i16: arrayPool<Int16Array>({ ctor: Int16Array }),
        i32: arrayPool<Int32Array>({ ctor: Int32Array }),
        i64: arrayPool<BigInt64Array>({ ctor: BigInt64Array }),
        u8: arrayPool<Uint8Array>({ ctor: Uint8Array }),
        u16: arrayPool<Uint16Array>({ ctor: Uint16Array }),
        u32: arrayPool<Uint32Array>({ ctor: Uint32Array }),
        u64: arrayPool<BigUint64Array>({ ctor: BigUint64Array }),
        'i8[]': arrayPool<Int8Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new Int8Array()) }),
        'i16[]': arrayPool<Int16Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new Int16Array()) }),
        'i32[]': arrayPool<Int32Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new Int32Array()) }),
        'i64[]': arrayPool<BigInt64Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new BigInt64Array()) }),
        'u8[]': arrayPool<Uint8Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new Uint8Array()) }),
        'u16[]': arrayPool<Uint16Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new Uint16Array()) }),
        'u32[]': arrayPool<Uint32Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new Uint32Array()) }),
        'u64[]': arrayPool<BigUint64Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new BigUint64Array()) }),
        'f64[]': arrayPool<Float64Array<ArrayBuffer>[]>({ ctor: Array, clear: fillWith(new Float64Array()) }),
    },
    arrayPool: arrayPool
}
