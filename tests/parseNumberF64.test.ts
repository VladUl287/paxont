...
describe('parseNumberF64', () => {
  ...
  describe('Edge cases and boundaries', () => {
    ...
    test('whole max value number', () => {
      const bytes = toBytes('')
      expect(parseNumberF64(bytes, 0)).toStrictEqual({ value: 1.7976931348623157e+308, nextIndex: 309 })
    })
  })
